...
**Preferred method:** Use [GitHub Private Vulnerability Reporting](https://docs.github.com/en/code-security/security-advisories/guidance-on-reporting-and-writing/privately-reporting-a-security-vulnerability) — click **"Report a vulnerability"** on the Security tab of the affected repository.
